    ...
    <b-tabs small v-model="tabIndex">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input
                ...
                class="form-control"
                maxlength="255"
                v-model="wishModel.nom"
                @keyup="valueChanged('nom', wishModel.nom)"
              />
            </div>
          </div>
          <!-- Image(s) -->
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <input
                ...
                class="form-control"
                maxlength="1024"
                v-model="wishModel.image"
                @keyup="valueChanged('image', wishModel.image)"
              />
            </div>
            <div class="col-sm-3">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input
                ...
                class="form-control"
                maxlength="1024"
                v-model="wishModel.lien"
                @keyup="valueChanged('lien', wishModel.lien)"
              />
            </div>
          </div>
          <!-- Niveau de désir -->
            ...
            <div class="col-sm-9">
              <div class="input-group">
                ...
                <input
                  ...
                  v-model="wishModel.happiness"
                  @keyup="valueChanged('happiness', wishModel.happiness)"
                />
              </div>
            </div>
          </div>
              ...
              <div class="col-sm-5">
                <big>
                  <input
                    ...
                    value="1"
                    checked="checked"
                    v-model="wishModel.lientype"
                    @keyup="valueChanged('lientype', wishModel.lientype)"
                  />
                  <font-awesome-icon :icon="icons.unlock" size="sm" class="ml-1" /> Libre &nbsp;
                  <input type="radio" name="lientype" value="2" v-model="wishModel.lientype" @keyup="valueChanged('lientype', wishModel.lientype)" />
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input
                  ...
                  placeholder="Maison"
                  maxlength="255"
                  v-model="wishModel.category"
                  @keyup="valueChanged('category', wishModel.category)"
                />
              </div>
            </div>
            <!-- Prix -->
              ...
              <div class="col-sm-9">
                <div class="input-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    placeholder="Prix"
                    v-model="wishModel.prix"
                    @keyup="valueChanged('prix', wishModel.prix)"
                  />
                </div>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <textarea
                  class="form-control"
                  name="info"
                  placeholder="super commentaire"
                  cols="35"
                  rows="2"
                  maxlength="255"
                  style="resize: none"
                  v-model="wishModel.info"
                  @keyup="valueChanged('info', wishModel.info)"
                ></textarea>
              </div>
            </div>
          </div>
      ...
      <b-tab @click="initList()">
        ...
        <div class="d-flex flex-row">
          ...
          <div class="align-items-center flex-fill ml-5">
            <div class="input-group mb-2 mt-2">
              <div class="input-group-prepend">
                <span class="input-group-text"><font-awesome-icon :icon="icons.filter"/></span>
              </div>
              <input
                type="text"
                name="nom"
        ...
        <b-list-group>
          <b-list-group-item
            href="#"
            :active="listinfo.hashcode + '#' + listinfo.id === currentListValue"
            v-for="listinfo in filteredListInfo"
            :key="listinfo.hashcode + '#' + listinfo.id"
...
export default {
  ...
  methods: {
    ...
    filterList() {
      let data = this.$store.state.followList.concat(this.$store.state.myList).filter(listinfo => {
