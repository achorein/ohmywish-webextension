  ...
  <div>
    <div class="rounded options-content">
      ...
      <p class="alert alert-info">
        Pour utiliser cette extension un compte est nécessaire sur le site <a href="https://www.wishing.space" target="_blank">wishing.space</a>.
      </p>
      <Messages></Messages>
      <form name="infoForm">
        <div class="form-group row">
            ...
            <div class="input-group col-sm-7">
                ...
                <input type="email" name="email-wishspace" v-model="email"
                  autocomplete="false" placeholder="monadresse@mail.com" class="form-control"/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 control-label">Mot de passe</label>
            <div class="input-group col-sm-7">
              <input type="password" name="password-wishspace" v-model="password"
                autocomplete="false" placeholder="mon mot de passe" class="form-control"/>
            </div>
        </div>
      </form>
    </div>
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      this.loginUser({ username: this.email, password: this.password }).then(response => {
